...
final class NativeMapView {
  ...
  private native void nativeRemoveLayerById(String layerId) throws NoSuchLayerException;

  private native void nativeRemoveLayer(long layerId) throws NoSuchLayerException;
  ...
  private native void nativeRemoveSourceById(String sourceId) throws NoSuchSourceException;

  private native void nativeRemoveSource(long sourcePtr) throws NoSuchSourceException;
